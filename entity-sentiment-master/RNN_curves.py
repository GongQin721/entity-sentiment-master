...
plt.figure(1)
plt.plot(list(range(50)),train_costs_RNN,label='RNN Train cost')
plt.plot(list(range(50)),dev_costs_RNN,label='RNN Dev cost')
plt.plot(list(range(50)),train_costs_BRNN,label='BRNN Train cost')
plt.plot(list(range(50)),dev_costs_BRNN,label='BRNN dev cost')
plt.legend()
plt.show()
